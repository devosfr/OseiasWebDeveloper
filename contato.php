          ...
          <h3 style="color:#666666">
            ...
            <form name="enviar" action="email.php" method="post" role="form">
              ...
              <div class="form-group">
                ...
                <input type="text" required maxlength="80" placeholder="assunto" name="assunto" id="phone" class="form-control">
              </div>
              <div class="form-group">
                <label for="phone">
                  <h4 style="color:#999999">Mensagem</h4>
                </label>
                <textarea placeholder="" rows="5" class="form-control" name="mensagem" placeholder="Mensagem"></textarea>
              </div>
